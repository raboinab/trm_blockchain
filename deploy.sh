...
# docker build --platform linux/amd64 -t trm_blockchain/$1 ../app
# docker tag trm_blockchain/$1:latest ${REPOSITORY_URL}:latest
# docker tag trm_blockchain/$1:latest ${REPOSITORY_URL}:${HASH}
